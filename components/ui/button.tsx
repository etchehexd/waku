...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-waku-400 focus-visible:ring-offset-2 focus-visible:ring-offset-abyss-950 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97] select-none",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-b from-waku-400 to-waku-600 text-white shadow-glow hover:from-waku-300 hover:to-waku-500",
        // The app's headline call to action (e.g. Add to Library). Violet keeps
        // it distinct from the blue chrome and from status colors.
        accent:
          "bg-gradient-to-b from-iris-400 to-iris-600 text-white shadow-glow-iris hover:from-iris-300 hover:to-iris-500",
        glass:
        ...
        "glass-primary":
          "glass glass-sheen text-white shadow-glow ring-1 ring-inset ring-waku-300/60 hover:ring-waku-200/80 hover:text-white",
